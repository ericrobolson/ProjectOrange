...
TODO: Move from promise worker to observable worker?
...
// Wrapper class
export class ObservableWorker<TInput, TOutput> {
  ...
  oche(value: TInput) : Observable<TOutput> {
    var obs = new Observable<TOutput>();
